...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : LaunchAWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: LaunchAWidget.routeName,
          path: LaunchAWidget.routePath,
          builder: (context, params) => LaunchAWidget(),
        ),
        FFRoute(
          name: LaunchBWidget.routeName,
          path: LaunchBWidget.routePath,
          builder: (context, params) => LaunchBWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            ...
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'Transaction')
                : NavBarPage(
                    initialPage: 'Transaction',
                    page: TransactionWidget(),
                  )),
        FFRoute(
