...
export '/login_sing_up/forgot_password/forgot_password_widget.dart'
    show ForgotPasswordWidget;
export '/login_sing_up/new_password/new_password_widget.dart'
...
export '/transactions/transaction/transaction_widget.dart'
    show TransactionWidget;
export '/analysis/analysis/analysis_widget.dart' show AnalysisWidget;
export '/categories/categories/categories_widget.dart' show CategoriesWidget;
export '/profile/profile/profile_widget.dart' show ProfileWidget;
export '/family/family_creation/family_creation_widget.dart'
